...
processor.run(new TypeormDatabase({ supportHotBlocks: true }), async (ctx) => {
    ...
    for (let c of ctx.blocks) {
        ...
        // NOTE: Trace handling disabled — requires paid RPC with debug_traceBlockByHash.
        // All QuickSync-critical data (commitments, nullifiers, shields) comes from events above.
    }
